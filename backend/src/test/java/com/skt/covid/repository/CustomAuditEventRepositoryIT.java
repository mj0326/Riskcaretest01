...
import com.skt.covid.config.audit.AuditEventConverter;
import com.skt.covid.domain.PersistentAuditEvent;
...
import static com.skt.covid.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
